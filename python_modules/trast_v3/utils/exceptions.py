"""Enhanced custom exceptions for Trast Parser V3"""
...
class ProxyCircuitBreakerOpen(ProxyException):
    """Proxy circuit breaker is open"""
    pass
...
class DriverHealthCheckFailed(BrowserException):
...
class PagePartialLoadError(PageException):
    """Page partially loaded (needs retry)"""
    pass
...
class RetryExhausted(TrastParserException):
